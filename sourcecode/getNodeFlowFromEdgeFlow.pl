...
# my @resFiles = `find $inDir -name "prim.simp.result.DB00543.10.txt"`; 
...
# perl getNodeFlowFromEdgeFlow.pl --inDir /public/ZhangJinLab/project_pharpath/PNet/Result/SDrTDi/10 --outDir /public/ZhangJinLab/project_pharpath/PNet/Result/SDrTDi/10
